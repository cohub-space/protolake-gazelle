...
// is referenced via cross-package srcs; bundle-specific args (package name,
// version) are baked at gazelle time, eliminating the runtime ${VERSION} dance.
...
// registry, ...) are still selected at runtime via NPM_PUBLISH_MODE; only
// package coordinates move from runtime ${VERSION} to gazelle-baked literals.
